...
uses
  ...
  MonolitoFinanceiro.Model.resources.interfaces in 'src\Model\resources\MonolitoFinanceiro.Model.resources.interfaces.pas',
  MonolitoFinanceiro.Model.resources.conexao in 'src\Model\resources\MonolitoFinanceiro.Model.resources.conexao.pas',
  MonolitoFinanceiro.Model.resources.configuracao in 'src\Model\resources\MonolitoFinanceiro.Model.resources.configuracao.pas',
  MonolitoFinanceiro.Model.resources.query in 'src\Model\resources\MonolitoFinanceiro.Model.resources.query.pas',
  MonolitoFinanceiro.Model.dao.base in 'src\Model\dao\MonolitoFinanceiro.Model.dao.base.pas',
  MonolitoFinanceiro.Model.dao.usuario in 'src\Model\dao\MonolitoFinanceiro.Model.dao.usuario.pas',
  MonolitoFinanceiro.EntityManager in 'src\Util\MonolitoFinanceiro.EntityManager.pas',
  MonolitoFinanceiro.Model.Entidades.Factory in 'src\Model\Entidades\MonolitoFinanceiro.Model.Entidades.Factory.pas';
